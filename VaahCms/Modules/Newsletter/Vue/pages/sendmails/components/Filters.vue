...
import { usesendmailStore } from '../../../stores/store-sendmails'
import VhFieldVertical from './../../../vaahvue/vue-three/primeflex/VhFieldVertical.vue'

const store = usesendmailStore();
            ...
            <Panel class="is-small">
                ...
                <template #icons>
                    ...
                    <div class="p-inputgroup">
                        ...
                        <Button data-testid="sendmails-hide-filter"
                                class="p-button-sm"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-none"
                                 inputId="sort-none"
                                 data-testid="sendmails-filters-sort-none"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-ascending"
                                 ...
                                 data-testid="sendmails-filters-sort-ascending"
                                 value="updated_at"
                                 v-model="store.query.filter.sort" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-descending"
                                 ...
                                 data-testid="sendmails-filters-sort-descending"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-all"
                                 inputId="active-all"
                                 value="null"
                                 data-testid="sendmails-filters-active-all"
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-true"
                                 inputId="active-true"
                                 data-testid="sendmails-filters-active-true"
                                 value="true"
                                 v-model="store.query.filter.is_active" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-false"
                                 ...
                                 data-testid="sendmails-filters-active-false"
                                 value="false"
                                 v-model="store.query.filter.is_active" />
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-exclude"
                                 ...
                                 data-testid="sendmails-filters-trashed-exclude"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-include"
                                 ...
                                 data-testid="sendmails-filters-trashed-include"
                                 value="include"
                                 v-model="store.query.filter.trashed" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-only"
                                 ...
                                 data-testid="sendmails-filters-trashed-only"
                                 value="only"
                                 v-model="store.query.filter.trashed" />
