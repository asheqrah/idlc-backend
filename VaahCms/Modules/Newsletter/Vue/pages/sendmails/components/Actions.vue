        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="sendmails-actions-menu"
                    aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="sendmails-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="sendmails-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                type="button"
                                class="p-button-sm"
                                :disabled="Object.keys(route.params).length"
                                data-testid="sendmails-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="sendmails-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
                                ...
                                <Button
                                    ...
                                    data-testid="sendmails-actions-bulk-menu"
                                    aria-haspopup="true"
