...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-newsletter';
        ...
        */
        ...
        return view('newsletter::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.newsletter_version')??config('newsletter.version'),
            'is_dev' => config('newsletter.is_dev'),
        ];
