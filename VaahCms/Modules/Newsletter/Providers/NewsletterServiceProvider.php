<?php namespace VaahCms\Modules\Newsletter\Providers;


use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use VaahCms\Modules\Newsletter\Providers\RouteServiceProvider;
use VaahCms\Modules\Newsletter\Providers\EventServiceProvider;
...
class NewsletterServiceProvider extends ServiceProvider
{
    ...
    private function registerMiddleware($router) {
        ...
        //register middleware
        //$router->aliasMiddleware('sample.middleware', \Newsletter\Http\Middleware\SampleMiddleware::class);
    ...
    {
        $viewPath = resource_path('/views/vaahcms/modules/newsletter');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/views/vaahcms/modules/newsletter';
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/modules/newsletter/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/modules/newsletter');
